...
<body>
    ...
    <fieldset id="field"><h1>Ram Hyper 8GB detalles</h1></fieldset>
        ...
        <form action="alta_orden_pieza.php" method="post">
            ...
            <div>
                    ...
                    Se trata de una fuente de 600 watts de la marca EVGA
                    la mejor opcion para alimentar tus equipos mas exigentes
            </div>
