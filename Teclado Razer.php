...
<body>
    ...
    <fieldset id="field"><h1>Teclado Razer detalles</h1></fieldset>
        ...
        <form action="alta_orden_pieza.php" method="post">
            ...
            <div>
                   ...
                   Un teclado mecanico switches rojos de un alto comfort y gran durabilidad pero sobre todo gran precision
            </div>
