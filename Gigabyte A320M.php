...
<body>
    ...
    <fieldset id="field"><h1>Gigabyte A320M detalles</h1></fieldset>
        ...
        <form action="alta_orden_pieza.php" method="post">
            ...
            <div>
                   ...
                   Una placa madre bastante durable de la marca Gigabyte muy versatil y con mucho espacio para tus componentes
            </div>
