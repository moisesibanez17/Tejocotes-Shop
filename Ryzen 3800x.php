...
<body>
    ...
    <fieldset id="field"><h1>Ryzen 3800x detalles</h1></fieldset>
        ...
        <form action="alta_orden_pieza.php" method="post">
            ...
            <div>
                    ...
                    Un procesador bastante capaz y poderoso, para alimentar las computadoras mas exigentes y de la mas alta gama
            </div>
