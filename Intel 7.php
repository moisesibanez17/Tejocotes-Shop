...
<body>
    ...
    <fieldset id="field"><h1>Intel 7 detalles</h1></fieldset>
        ...
        <form action="alta_orden_pieza.php" method="post">
            ...
            <div>
                    ...
                    Otra alternativa de procesamiento bastante poderosa, el Intel 7 cubrira tus necesidades de computo mas demandantes
            </div>
